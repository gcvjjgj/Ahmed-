...
const multer = require('multer'); // تم تفعيله الآن لاستقبال الملفات
const admin = require('firebase-admin'); // تم تفعيله الآن لرفع الملفات إلى Firebase

const app = express();
// const port = process.env.PORT || 3000; // Vercel يحدد البورت تلقائياً
...
const connectDB = async () => {
    ...
    try {
        ...
        // لا تخرج من العملية هنا، السيرفر ما زال يمكن أن يقدم استجابات أخرى
...
// ----------------------------------------------------
// تأكد من وجود ملف serviceAccountKey.json في نفس مسار api/
